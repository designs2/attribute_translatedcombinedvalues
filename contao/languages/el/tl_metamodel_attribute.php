 ...
 *
 * last-updated: 2014-05-08T08:17:19+02:00
 */
...
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['combinedvalues_format']['0']  = 'Τυποι';
$GLOBALS['TL_LANG']['tl_metamodel_attribute']['combinedvalues_format']['1']  = 'Χρησιμοποιήστε "% s" ή οποιοδήποτε άλλο σύμβολο κράτησης θέσης για να δημιουργήσετε ένα διαμορφωμένο κείμενο. Δείτε το <a href="http://php.net/sprintf" onclick="window.open(this.href)">sprintf</a> για περισσότερες πληροφορίες. ';
